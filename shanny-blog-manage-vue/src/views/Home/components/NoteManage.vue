...
onMounted(async () => {
  await articleStore.getArticleList('ARTICLE_NOTE')
})
</script>
<template>
  <div>
    <div class="flex justify-end gap-2">
      <button
        ...
        @click="articleStore.deleteArticles('ARTICLE_NOTE')"
      >
        Delete
      </button>
            ...
            <th>
              <div class="flex gap-2">
                <button
                  ...
                  @click="articleStore.openEditArticle(item, 'note')"
                >
                  Edit
                </button>
                <button
                  class="btn btn-ghost btn-xs"
                  @click="articleStore.deleteArticle(item, 'ARTICLE_NOTE')"
                >
                  Delete
                </button>
              </div>
